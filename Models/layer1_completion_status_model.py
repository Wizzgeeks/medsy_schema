...
class Layer1_completion_status(Document):
    ...
    total_time_taken_layer2=IntField()
    ...
    def to_json(self):
        return {
            ...
            "total_time_taken_layer2":self.total_time_taken_layer2,
            "total_page_count":self.total_page_count,
            "completed_page_count":self.completed_page_count,
            "total_layer2_count":self.total_layer2_count,
            "completed_layer2_count":self.completed_layer2_count
            }
