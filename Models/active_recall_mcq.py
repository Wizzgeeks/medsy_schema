...
class Active_recall_mcq(Document):
    ...
    def to_active(self):
        return {
            ...
            "subject": {"name":str(self.subject.name),"key":str(self.subject.key)} if self.subject else None,
            "layer1":{"name":str(self.layer1.name) ,"key":str(self.layer1.key) } if self.layer1 else None,
            "layer2": {"name":str(self.layer2.name) ,"key":str(self.layer2.key) } if self.layer2 else None,
            "layer3": {"name":str(self.layer3.name) ,"key":str(self.layer3.key) } if self.layer3 else None,
