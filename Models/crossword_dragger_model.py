...
class CrosswordDragger(Document):
    course = ReferenceField(Course, reverse_delete_rule=CASCADE, required=True)
    year = ReferenceField(Year, reverse_delete_rule=CASCADE, required=True)
    subject = ReferenceField(
        Subject, reverse_delete_rule=CASCADE, required=True)
    ...
    content = ListField()
    prompt = ReferenceField(
        Prompt_content, reverse_delete_rule=CASCADE, null=True)
