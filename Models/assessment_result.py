...
class AssessmentResult(Document):
    ...
    def to_get(self):
        return {
            "id": str(self.id),
            "user": {"id":str(self.user.id),"name":self.user.username,"user_id":self.user.user_id,"course":self.user.course_id.name,"year":self.user.year_id.year,"course":self.user.course_id.id,"year":self.user.year_id.id} if self.user else None,
